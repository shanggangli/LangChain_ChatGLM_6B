...
# 修改成自己的配置！！！
class LangChainCFG:
    llm_model_name = 'model_chatGLM_6b_int4'  # 本地模型文件 or huggingface远程仓库
    embedding_model_name = 'text2ver_large_chinese'  # 检索模型文件 or huggingface远程仓库
...
config = LangChainCFG()
print('111111:',config.kg_vector_stores.keys())
...
with gr.Blocks(css=customCSS, theme=small_and_beautiful_theme) as demo:
    ...
    with gr.Row():
        ...
        with gr.Column(scale=4):
            ...
            with gr.Row():
                gr.Markdown("""提醒：<br>
                                        [LangChain_ChatGLM_6B](https://github.com/shanggangli/LangChain_ChatGLM_6B) <br>
                                        有任何使用问题[Github Issue区](https://github.com/shanggangli/LangChain_ChatGLM_6B/issues)进行反馈. <br>
                                        """)
